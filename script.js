...
function loadDefaultContent() {
    ...
    document.getElementById('djsContainer').innerHTML = `
        <div class="dj-card">
            <div class="dj-image" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
    ...
    document.getElementById('top5Container').innerHTML = `
        <div class="top5-item">
            ...
            <div class="top5-thumbnail" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);"></div>
            <div class="top5-info">
