...
const SHEET_ID = '1eoVc2IeX8hjOLpV6zkkBj3gr_KtkOmYbh7wviK7McyM';
...
class RadioPlayer {
    constructor() {
        ...
        this.audio = null;
        this.streamUrl = 'https://stream.zeno.fm/dlvtl3hthyxvv';
    ...
    previousTrack() {
        const tracks = [
            { title: 'Radio Power - EN VIVO', artist: 'Música Electrónica 24/7' },
            { title: 'Synthwave Nights', artist: 'DJ Synth' },
            { title: 'Dubstep Revolution', artist: 'DJ Luna' },
            { title: 'Classic 90s Mix', artist: 'JD Cesar' }
        ];
    ...
    nextTrack() {
        const tracks = [
            { title: 'Radio Power - EN VIVO', artist: 'Música Electrónica 24/7' },
            { title: 'Electronic Dreams', artist: 'DJ Synth' },
            { title: 'Bass Drop Zone', artist: 'DJ Luna' },
            { title: 'Retro Vibes', artist: 'JD Cesar' }
        ];
